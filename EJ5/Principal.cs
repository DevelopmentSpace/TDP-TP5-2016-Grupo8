...
namespace EJ5
{
    public partial class Principal : Form
    {
        ...
        {
            //Calculamos segun se quiera usar la figura circulo o triangulo
            if (opcionTriangulo.Checked)
            {
                //pasamos los puntos en string a double
                ...
                //Calculamos segun se quiera calcular el area o el permitreo
